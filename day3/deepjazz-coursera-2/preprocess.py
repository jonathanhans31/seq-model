...
def __parse_midi(data_fn):
    ...
    # solo_stream.show('text', addEndTimes=True)  
    # Group by measure so you can classify. 
    # Note that measure 0 is for the time signature, metronome, etc. which have
    # an offset of 0.0.
    melody_stream = solo_stream[-1]
    measures = OrderedDict()
    # melody_stream.show("text", addEndTimes=True)
    ...
    # print(len(solo_stream), solo_stream)
    ...
    # chordStream.show("text", addEndTimes=True)
...
def get_musical_data(data_fn):
    ...
    # print("measures_representation")
    # for bar in measures:
    #     print("Bar No:",bar, "Number of Note", len(measures[bar]))
    #     print(measures[bar])
    #     for note in measures[bar]:
    #         if note not in all_notes:
    #             all_notes.append(note)
    # print("Total unique note:", len(all_notes))
...
def get_corpus_data(abstract_grammars):
    ...
    # for sublist in abstract_grammars:
